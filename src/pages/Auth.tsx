        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-sidebar-foreground/70 max-w-md">
              Track projects, manage clients, send invoices, and grow your
            ...
            <div className="flex items-center gap-4 text-sidebar-foreground/60">
              <div className="flex -space-x-3">
                {["JD", "AS", "MK", "RL"].map((initials, i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-sm font-medium text-primary-foreground border-2 border-sidebar"
                  >
                    {initials}
                  </div>
                ))}
          ...
          <div className="grid grid-cols-3 gap-6 text-sidebar-foreground/80">
            <div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8 animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="btn-primary w-full gap-2 py-6">
